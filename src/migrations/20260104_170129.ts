...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_coaches_background_color" AS ENUM('peach', 'blue', 'green', 'yellow');
  CREATE TYPE "public"."enum_registrations_intention" AS ENUM('competition', 'recreation', 'fitness', 'other');
  CREATE TYPE "public"."enum_registrations_status" AS ENUM('pending', 'contacted', 'enrolled', 'cancelled');
  ...
  CREATE TABLE "coaches" (
  	...
  	"bio" jsonb NOT NULL,
  	"image_id" integer,
  	"background_color" "enum_coaches_background_color" DEFAULT 'peach',
  	"active" boolean DEFAULT true,
  	"order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  CREATE TABLE "registrations" (
  	...
  	"child_age" numeric NOT NULL,
  	"intention" "enum_registrations_intention" NOT NULL,
  	"program_id" integer NOT NULL,
  	"has_health_problems" boolean DEFAULT false,
  	"health_problems_details" varchar,
  	"referral_source" varchar,
  	"first_training_date" timestamp(3) with time zone,
  ...
  ALTER TABLE "coaches" ADD CONSTRAINT "coaches_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "registrations" ADD CONSTRAINT "registrations_program_id_groups_id_fk" FOREIGN KEY ("program_id") REFERENCES "public"."groups"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "coaches_image_idx" ON "coaches" USING btree ("image_id");
  ...
  CREATE INDEX "registrations_program_idx" ON "registrations" USING btree ("program_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_coaches_background_color";
  DROP TYPE "public"."enum_registrations_intention";
